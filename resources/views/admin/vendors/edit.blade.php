                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form role="form" id="quickForm" method="post" action="{{ route('vendors.update', $id) }}" enctype="multipart/form-data">
                                @csrf
                                @method('put')
                                <div class="card-body">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <select name="parent_id" class="form-control" id="city_id">
                                                ...
                                                @foreach ($vendors as $record)
                                                    <option value="{{ $record->id }}" @if($details->parent_id == $record->id) selected @endif>{{ json_decode($record->name, true)['en'] . " - " . json_decode($record->name, true)['ar'] }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <img style="width: 50px;" src="{{ url('images/vendor_files/' . $details->logo) }}" alt="">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <img style="width: 50px;" src="{{ url('images/vendor_files/' . $details->cover) }}" alt="">
                                            <div class="input-group">
                                                <div class="custom-file">
